...
public class PlayerParryState : PlayerBaseState
{
	...
	public override void FixedTick()
	{
		...
		Vector3 velocity = isOnSlope ? AdjustDirectionToSlope(stateMachine.transform.forward) : stateMachine.transform.forward;//.normalized;
		Vector3 gravity = isOnSlope ? Vector3.zero : Vector3.down * Mathf.Abs(stateMachine.Rigidbody.velocity.y);

		stateMachine.Rigidbody.velocity = velocity * Time.fixedDeltaTime * stateMachine.MoveForce + gravity;
